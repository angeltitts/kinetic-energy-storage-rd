...
- motor/controller class and exact selected products
- belt pitch, tooth counts, width, and length
- nominal motor/shaft center distance
- DC bus product and commissioning current limits
- hub design
- guard thickness
- data schema
- test sequence
